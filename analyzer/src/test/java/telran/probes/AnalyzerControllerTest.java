...
class AnalyzerControllerTest {
    ...
    @Value("${app.analyzer.consumer.binding.name:analyzerProducer-in-0")
    ...
    @Test
    void testGreaterMaxDeviation() throws IOException {
    ...
    @Test
    void testLessMinDeviation() throws IOException {
